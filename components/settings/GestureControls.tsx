...
export const GestureControls = ({ ...props }: Props) => {
    ...
    <DisabledSetting disabled={disabled} {...props}>
      ...
      >
        ...
        >
          ...
          <Switch
            accessibilityLabel={t(
              "home.settings.gesture_controls.horizontal_swipe_skip",
            )}
        ...
        >
          ...
          <Switch
            accessibilityLabel={t(
              "home.settings.gesture_controls.left_side_brightness",
            )}
        ...
        >
          ...
          <Switch
            accessibilityLabel={t(
              "home.settings.gesture_controls.right_side_volume",
            )}
